...
<template>
   <div>
      ...
      <div class="form-group row">
         ...
         <label
               class="col-form-label col-form-label-lg col-3 text-nowrap text-right">{{$t('packageDetails.rentCar')}}</label>
      </div>
      <div v-if="show">
         <div class="form-group row">
            <div class="col-6 text-right offset-3">
         ...
         <div class="form-group row">
            ...
            <label class="col-form-label col-form-label-lg text-nowrap col-3 text-right">
      ...
      <div class="form-group row">
         ...
         <label
               class="col-form-label col-form-label-lg col-3 text-nowrap text-right">{{$t('packageDetails.toursNeed')}}</label>
      </div>
